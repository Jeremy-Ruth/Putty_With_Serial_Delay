...
#define WINHELP_CTX_serial_chardelay "serial.chardelay:config-serial-character-delay"       // JDR: Added for serial character and line delay
#define WINHELP_CTX_serial_linedelay "serial.linedelay:config-serial-line-delay"            // No cross-platform config has been done past this
